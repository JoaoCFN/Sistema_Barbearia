...
const Button = class {
  constructor(hostRef) {
    ...
    this.handleClick = (ev) => {
      ...
      else if (Object(_helpers_fde0057c_js__WEBPACK_IMPORTED_MODULE_2__["j"])(this.el)) {
