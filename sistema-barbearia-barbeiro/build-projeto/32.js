...
/* harmony import */ var _hardware_back_button_389954a0_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./hardware-back-button-389954a0.js */ "8RMS");
/* harmony import */ var _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-46020acc.js */ "psc6");
...
const Select = class {
  ...
  async openPopover(ev) {
    ...
    return _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_4__["c"].create(popoverOpts);
  }
  async openActionSheet() {
    const mode = Object(_ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this);
    const interfaceOptions = this.interfaceOptions;
    const actionSheetOpts = Object.assign(Object.assign({ mode }, interfaceOptions), { buttons: this.createActionSheetButtons(this.childOpts, this.value), cssClass: ['select-action-sheet', interfaceOptions.cssClass] });
    return _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_4__["b"].create(actionSheetOpts);
  }
  async openAlert() {
    ...
    return _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_4__["a"].create(alertOpts);
  }
  /**
  ...
  getLabel() {
    return Object(_helpers_fde0057c_js__WEBPACK_IMPORTED_MODULE_2__["f"])(this.el);
  }
  hasValue() {
    return this.getText() !== '';
  }
  ...
  render() {
    ...
    Object(_helpers_fde0057c_js__WEBPACK_IMPORTED_MODULE_2__["d"])(true, el, name, parseValue(value), disabled);
    const selectTextClasses = {
      'select-text': true,
      'select-placeholder': addPlaceholderClass
    };
    const textPart = addPlaceholderClass ? 'placeholder' : 'text';
    return (Object(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["H"], { onClick: this.onClick, role: "listbox", "aria-haspopup": "dialog", "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-labelledby": labelId, class: {
        [mode]: true,
        'in-item': Object(_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_5__["h"])('ion-item', el),
        'select-disabled': disabled,
      } }, Object(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: selectTextClasses, part: textPart }, selectText), Object(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "select-icon", role: "presentation", part: "icon" }, Object(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "select-icon-inner" })), Object(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: disabled, ref: (btnEl => this.buttonEl = btnEl) })));
  }
...
const SelectPopover = class {
  ...
  onSelect(ev) {
    ...
    if (option) {
      Object(_overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_4__["s"])(option.handler);
    }
  }
  render() {
