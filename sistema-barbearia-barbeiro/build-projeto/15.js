...
const Input = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object(_helpers_fde0057c_js__WEBPACK_IMPORTED_MODULE_2__["i"])(this.el, ['tabindex', 'title']);
  }
  connectedCallback() {
    this.emitStyle();
  ...
  render() {
    ...
    const label = Object(_helpers_fde0057c_js__WEBPACK_IMPORTED_MODULE_2__["f"])(this.el);
    if (label) {
      label.id = labelId;
    }
