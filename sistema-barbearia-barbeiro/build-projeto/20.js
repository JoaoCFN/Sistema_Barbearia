...
/* harmony import */ var _hardware_back_button_389954a0_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./hardware-back-button-389954a0.js */ "8RMS");
/* harmony import */ var _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./overlays-46020acc.js */ "psc6");
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const onMove = (detail) => {
    const step = Object(_helpers_fde0057c_js__WEBPACK_IMPORTED_MODULE_2__["h"])(0.0001, detail.deltaY / height, 0.9999);
...
const iosEnterAnimation = (baseEl, presentingEl) => {
  ...
  if (presentingEl) {
    ...
    const presentingAnimation = Object(_animation_8c514e52_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
      .beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = Object(_animation_8c514e52_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
          .afterStyles({
          'transform': finalTransform
        })
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_9__["B"]);
    };
    this.onDismiss = (ev) => {
      ev.stopPropagation();
      ev.preventDefault();
  ...
  async present() {
    ...
    await Object(_overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_9__["d"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
  ...
  async dismiss(data, role) {
    ...
    const enteringAnimation = _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_9__["h"].get(this) || [];
    const dismissed = await Object(_overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_9__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
    if (dismissed) {
