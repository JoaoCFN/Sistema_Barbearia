...
/* harmony import */ var _hardware_back_button_389954a0_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./hardware-back-button-389954a0.js */ "8RMS");
/* harmony import */ var _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./overlays-46020acc.js */ "psc6");
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.animated = true;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_8__["B"]);
    };
  ...
  callButtonHandler(button, data) {
    if (button && button.handler) {
      ...
      const returnData = Object(_overlays_46020acc_js__WEBPACK_IMPORTED_MODULE_8__["s"])(button.handler, data);
      if (returnData === false) {
  ...
  renderInput(labelledby) {
    ...
    return (Object(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(i => {
      var _a, _b, _c, _d;
      if (i.type === 'textarea') {
